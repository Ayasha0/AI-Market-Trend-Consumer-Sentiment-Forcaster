# Why are people suddenly unhappy with smart TVs
# Why are inverter batteries getting negative sentiment this week?
...
def run_scheduler():
    ...
    schedule.every().sunday.at("02:00").do(news.get_news_data)
    schedule.every().sunday.at("03:00").do(reddit_api.reddit_api)
        ...
        if ask_btn and user_query:
            ...
            """   
                try:
                    ...
                    # final_model = 'groq'
                    final_answer = groq_response.choices[0].message.content
            
            st.success("Insight Generated")
            # st.success(final_model)
