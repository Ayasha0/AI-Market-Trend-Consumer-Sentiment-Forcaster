...
def get_news_data():
    try:
        ...
        if result_df.empty:
            send_mail("News Data Alert", "News Data Extracted Successfully and No major weekly Reddit sentiment spikes or trend shifts detected." )
        else:
            send_mail("News Data Alert", "News Data Extracted Successfully and please find the attached report of sentiment spike and trend shift of this week", result_df )
        ...
        send_mail("News Data Alert", f"Failed to Extract News Data and the reason is: {e}")
