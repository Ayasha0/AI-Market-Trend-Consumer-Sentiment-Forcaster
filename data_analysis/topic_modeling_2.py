...
# config 
INPUT_FILE="temp/sentiment_categorized_products.csv"
OUTPUT_FILE="temp/category_wise_lda_output.csv"
...
df = df.dropna(subset=["review_text", "category"])
df = df[df["review_text"].str.strip()!=""]


# apply additional cleaning for LDA
df["lda_text"]= df["review_text"].apply(clean_for_lda)
