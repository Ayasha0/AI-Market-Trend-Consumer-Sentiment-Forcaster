...
# load files  
df_flip = pd.read_csv("data/flipkart_cleaned_data.csv")
df_amazon = pd.read_csv("data/amazon_cleaned_data.csv")
...
# save ouput
df.to_csv("temp/combined_cleaned_data.csv", index=False, encoding='utf-8')
